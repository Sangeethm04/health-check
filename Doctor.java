...
/*Analyze and offer treatment to various illnesses*/
public class Doctor {
    public static void main(String[] args) {
        Illness covid = new Illness("COVID-19", "A virus that causes COVID-19", "Treat with antibiotics", new String[] {
            "fever",
            "cough",
            "shortness of breath"
        }, new String[] {
        ...
        Illness diarrhea = new Illness("DIARRHEA", "A virus that causes DIARRHEA", "Treat with antibiotics", new String[] {
            "fever",
            "cough",
            "shortness of breath"
        }, new String[] {
